								...
								<Tooltip>
									...
									<TooltipContent>
										<p className="max-w-xs">
											Control who can see your profile information on RomieSwipe
										</p>
									</TooltipContent>
								</Tooltip>
							</TooltipProvider>
						...
						<div className="space-y-4">
							...
							<div className="flex items-center justify-between">
								<Label htmlFor="show-online-status" className="flex-1">
									...
									<p className="text-sm font-normal text-muted-foreground">
										Let others see when you're active on RomieSwipe
									</p>
								</Label>
								<Switch
							...
							<div className="flex items-center justify-between">
								<Label htmlFor="show-last-active" className="flex-1">
									...
									<p className="text-sm font-normal text-muted-foreground">
										Let others see when you were last active on RomieSwipe
									</p>
								</Label>
								<Switch
									id="show-last-active"
									...
									onCheckedChange={(checked) =>
										handleToggle('showLastActive', checked)
									}
								/>
							</div>
						</div>
						...
						<div className="space-y-4">
							<div className="space-y-2">
								...
								<RadioGroup
									...
									onValueChange={(value) =>
										handleRadioChange('allowLocationSharing', value)
									}
								>
									<div className="flex items-center space-x-2">
						...
						<div className="space-y-4">
							<div className="flex items-center justify-between">
								<Label htmlFor="allow-personalization" className="flex-1">
									...
									<p className="text-sm font-normal text-muted-foreground">
										Allow us to use your data to provide personalized roommate
										recommendations
									</p>
								</Label>
								<Switch
									...
									onCheckedChange={(checked) =>
										handleDataUsageToggle('allowPersonalization', checked)
									}
								/>
							</div>
							<div className="flex items-center justify-between">
								...
								<Switch
									...
									onCheckedChange={(checked) =>
										handleDataUsageToggle('allowAnalytics', checked)
									}
								/>
							</div>
							<div className="flex items-center justify-between">
								...
								<Switch
									...
									onCheckedChange={(checked) =>
										handleDataUsageToggle('allowThirdPartySharing', checked)
									}
								/>
							</div>
						</div>
