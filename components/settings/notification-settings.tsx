...
export default function NotificationSettings({ onSave }: NotificationSettingsProps) {
  ...
  const handleToggle = (category: "email" | "inApp" | "push", setting: string, value: boolean) => {
    setSettings((prev) => ({
      ...prev,
      [category]: {
        ...prev[category],
    ...
    <form onSubmit={handleSubmit}>
      <Card>
        <CardHeader>
          ...
          <CardDescription>Control how and when you receive notifications from RoomieMatch</CardDescription>
        </CardHeader>
                ...
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p className="max-w-xs">
                      Email notifications are sent to your registered email address. You can unsubscribe from marketing
                      emails at any time.
                    </p>
                  </TooltipContent>
                </Tooltip>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => handleToggle("email", "newMatches", checked)}
                />
              </div>
              <div className="flex items-center justify-between">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => handleToggle("email", "profileViews", checked)}
                />
              </div>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => handleToggle("email", "roommateSuggestions", checked)}
                />
              </div>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => handleToggle("email", "accountUpdates", checked)}
                />
              </div>
              <div className="flex items-center justify-between">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => handleToggle("inApp", "newMatches", checked)}
                />
              </div>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => handleToggle("inApp", "messages", checked)}
                />
              </div>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => handleToggle("inApp", "profileViews", checked)}
                />
              </div>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => handleToggle("inApp", "roommateSuggestions", checked)}
                />
              </div>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => handleToggle("inApp", "accountUpdates", checked)}
                />
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => handleToggle("push", "newMatches", checked)}
                />
              </div>
              <div className="flex items-center justify-between">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => handleToggle("push", "profileViews", checked)}
                />
              </div>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => handleToggle("push", "roommateSuggestions", checked)}
                />
              </div>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => handleToggle("push", "accountUpdates", checked)}
                />
              </div>
            </div>
          </div>
